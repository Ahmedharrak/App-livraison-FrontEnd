...
class FiltresHistouriquesLivreur extends StatefulWidget {
  @override
  _FiltresHistouriquesLivreurState createState() =>
      _FiltresHistouriquesLivreurState();
}

class _FiltresHistouriquesLivreurState
    extends State<FiltresHistouriquesLivreur> {
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: new FutureBuilder<List>(
                                        future: livraisonController
                                            .obtenirHistoriquesParIdLivreur(
                                                idLivreur,
                                                dateLivraison,
                                                contenu,
                                                nature,
