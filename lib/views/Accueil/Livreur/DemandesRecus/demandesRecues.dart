...
import 'package:livreurs_app/views/Accueil/Livreur/DemandesRecus/filtresDemandesRecus.dart';
import 'package:livreurs_app/views/Accueil/Livreur/DemandesRecus/livreurAccepterDemandePrive.dart';
import 'package:livreurs_app/views/Accueil/accueilLivreur.dart';
import 'package:livreurs_app/const.dart' as Const;

class DemandesRecues extends StatefulWidget {
  ...
  const DemandesRecues(
      ...
      : super(key: key);
  @override
  _DemandesRecuesState createState() => _DemandesRecuesState(
      villeDeDepart,
      villeDeLivraison,
      regionRecuperation,
      regionLivraison,
...
class _DemandesRecuesState extends State<DemandesRecues> {
...
/////////////////widget///////////////////
  ...
  Widget build(BuildContext context) {
    if (triePar == null)
      aaa = demandeController.obtenirDemandesRecusParId(
          idLivreur,
          dateLivraison,
          contenu,
          nature,
                    ...
                    child: FlatButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => FiltresDemandesRecus()),
                        );
                      },
                      child: Padding(
                        padding: EdgeInsets.only(
