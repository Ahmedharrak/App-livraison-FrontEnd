...
import 'package:livreurs_app/views/Accueil/Livreur/FutursLivraisons/suiviDemandeActiveLivreur.dart';
...
class DetailLivraisonLivreur extends StatelessWidget {
  String idLivraison;
  ...
  Widget build(BuildContext context) {
    ...
    _onPressedAnnuler() {
      livraisonController.statutlivraison(idLivraison, "Annulé par livreur");
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: InkWell(
                    onTap: () {
                      /*Navigator.push(
                              context, new MaterialPageRoute(builder: (context) =>DetailCommunicationClient()));*/
                    },
                    child: Text(
              ...
              child: FlatButton(
                onPressed: () => {
                  notificationController.ajouterNotification(
                      ...
                      idLivraison,
                      "A",
                      "est en route de récupération de votre livraison.",
                      todayNotification),
                  livraisonController.modifierStatutDemande(
                      idLivraison, "En cours"),
                  Navigator.push(
                      context,
                      new MaterialPageRoute(
                          builder: (context) => SuiviDemandeActiveLivreur(
                              demande: demande,
