...
import 'package:livreurs_app/views/Accueil/Client/ListeLivreurs/EnvoyerDemandePrive/envoyerDemandePriveQuoi.dart';
...
class EnvoyerDemandePriveQuand extends StatefulWidget {
  ...
  @override
  EnvoyerDemandePriveQuandState createState() => EnvoyerDemandePriveQuandState(
        adresseRecuperation,
        villeRecuperation,
        adresseLivraison,
        villeLivraison,
...
class EnvoyerDemandePriveQuandState extends State<EnvoyerDemandePriveQuand> {
  String adresseRecuperation;
  String villeRecuperation;
  String adresseLivraison;
  String villeLivraison;
                          ...
                          child: Row(
                            children: [
                              ...
                              Container(
                                margin:
                                    const EdgeInsets.only(left: 10, right: 5),
                                child: ImageIcon(AssetImage("assets/clock.png"),
                ...
                onPressed: () {
                  if (dateLivraison.text == "" || heureLivraison.text == "") {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => EnvoyerDemandePriveQuoi(
                                idLivreur: "$idLivreur",
