...
import 'package:livreurs_app/views/Accueil/Client/PublierDemande/publierDemandeQuand.dart';
...
class PublierDemandeComment extends StatefulWidget {
  ...
  @override
  PublierDemandeCommentState createState() => PublierDemandeCommentState(
      adresseRecuperation, villeRecuperation, adresseLivraison, villeLivraison);
}

class PublierDemandeCommentState extends State<PublierDemandeComment> {
  String adresseRecuperation;
  String villeRecuperation;
  String adresseLivraison;
  String villeLivraison;
  String dure, distance;
  PublierDemandeCommentState(this.adresseRecuperation, this.villeRecuperation,
      this.adresseLivraison, this.villeLivraison);
                ...
                onPressed: () {
                  if (valueVoiture == false &&
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => PublierDemandeQuand(
