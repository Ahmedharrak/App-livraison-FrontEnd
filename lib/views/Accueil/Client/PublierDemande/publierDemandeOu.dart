...
import 'package:livreurs_app/views/Accueil/Client/PublierDemande/publierDemandeComment.dart';
...
class PublierDemandeOu extends StatefulWidget {
  @override
  PublierDemandeOuState createState() => PublierDemandeOuState();
}

class PublierDemandeOuState extends State<PublierDemandeOu> {
  ...
  bool _validateAdresseRecuperation = false, _validateAdresseLivraison = false;
  @override
          ...
          children: [
                      ...
                      children: [
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: "Avenue.... ",
                            errorText: _validateAdresseRecuperation
                                ? 'La valeur d\'Adresse de récupération ne peut pas être vide'
                                : null,
                            hintStyle: TextStyle(
                                color: Colors.grey,
                                fontSize: 15,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: "Avenue...",
                            errorText: _validateAdresseLivraison
                                ? 'La valeur d\'adresse de livraison ne peut pas être vide'
                                : null,
                            hintStyle: TextStyle(
                                color: Colors.grey,
                                fontSize: 15,
            ...
            Container(
              ...
              child: FlatButton(
                onPressed: () async {
                  setState(() {
                    adresseRecuperation.text.isEmpty
                        ? _validateAdresseRecuperation = true
                        : _validateAdresseRecuperation = false;
                    adresseLivraison.text.isEmpty
                        ? _validateAdresseLivraison = true
                        : _validateAdresseLivraison = false;
                  });
                  ...
                  if (adresseRecuperation.text == "" &&
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => PublierDemandeComment(
                                adresseRecuperation:
