...
class PublierDemandeQuoi extends StatefulWidget {
  ...
  @override
  PublierDemandeQuoiState createState() => PublierDemandeQuoiState(
        this.adresseRecuperation,
        this.villeRecuperation,
        this.adresseLivraison,
        this.villeLivraison,
...
class PublierDemandeQuoiState extends State<PublierDemandeQuoi> {
  String adresseRecuperation;
  String villeRecuperation;
  String adresseLivraison;
  String villeLivraison;
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: FlatButton(
                onPressed: () => _onPressedPublierDemande(),
                child: Text(
                  "Publier",
                  style: TextStyle(
                    color: Colors.white,
  ...
  _onPressedPublierDemande() async {
