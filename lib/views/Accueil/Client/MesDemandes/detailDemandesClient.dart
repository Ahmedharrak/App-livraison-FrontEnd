...
import 'package:livreurs_app/views/Accueil/Client/MesDemandes/modifierDetailDemandeClient.dart';
...
class DetailDemandesClient extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    _onPressedAnnuler() {
      ...
      demandeController.annulerDemande(idDemande).whenComplete(() {
    ...
    _onPressedModifier() {
      Navigator.push(
          ...
          new MaterialPageRoute(
              builder: (context) =>
                  ModifierDetailDemandeClient(demande: demande)));
    }
