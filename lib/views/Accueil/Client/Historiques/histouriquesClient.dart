...
class HistouriquesClient extends StatefulWidget {
  ...
  HistouriquesClient(
      ...
      : super(key: key);
  @override
  _HistouriquesClientState createState() => _HistouriquesClientState(
      contenu,
      nature,
      taille,
      poids,
...
class _HistouriquesClientState extends State<HistouriquesClient> {
